...
### Dependencies
- Bump `stefanzweifel/git-auto-commit-action` from 5.0.0 to 5.1.0 ([#287](https://github.com/dangoslen/changelog-enforcer/pull/287), [#294](https://github.com/dangoslen/changelog-enforcer/pull/294))
