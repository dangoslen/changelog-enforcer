...
### Dependencies
- Bump `eslint` from 8.57.0 to 9.8.0 ([#288](https://github.com/dangoslen/changelog-enforcer/pull/288), [#292](https://github.com/dangoslen/changelog-enforcer/pull/292))
