...
- Bump `eslint` from 8.57.0 to 9.22.0 ([#288](https://github.com/dangoslen/changelog-enforcer/pull/288), [#296](https://github.com/dangoslen/changelog-enforcer/pull/296))
